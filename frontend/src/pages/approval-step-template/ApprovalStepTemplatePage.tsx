...
export default function ApprovalStepTemplatePage() {
  ...
  const [approverTypeFilter, setApproverTypeFilter] = useState<
    ApproverType | typeof ALL_APPROVER_TYPES
  >(ALL_APPROVER_TYPES);
    ...
    <Card className="p-5">
      <div className="space-y-6">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            <h2 className="text-xl font-bold tracking-tight">Mẫu bước duyệt</h2>
          </div>
        ...
        {canDelete ? (
          ...
          >
            <AlertDialogContent>
              <AlertDialogHeader>
                <AlertDialogTitle>Xóa mẫu bước duyệt?</AlertDialogTitle>
                <AlertDialogDescription>
                  Mẫu "{deletingTemplate?.stepName}" sẽ bị ẩn khỏi thư viện bước
                  duyệt.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
